...
static DX_TIMER_BINDING tmr_read_environment = {.timeout = &(timespec){2, 0}, .period = {30, 0}, .name = "tmr_read_environment", .handler = read_telemetry_handler};
static DX_TIMER_BINDING tmr_read_light_level = {.timeout = &(timespec){2, 0}, .period = {2, 0}, .name = "tmr_read_light_level", .handler = tmr_read_light_level_handler};
